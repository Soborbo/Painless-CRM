...
import { listJobs, listSalesReps } from '@/lib/queries/jobs';
...
type Props = {
  searchParams: Promise<{ q?: string; stage?: string; assigned_to_id?: string; page?: string }>;
};
...
export default async function JobsPage({ searchParams }: Props) {
  ...
  const [result, reps, t] = await Promise.all([
    listJobs(filters),
    listSalesReps(),
